...
INSERT INTO article VALUES ( 'Information about Web Site System:<br>\n<table>\n<tr><th>\nWSS version\n</th><td>\n<?echo $wss_version?>\n</td></tr>\n<tr><th>\nWSS author\n</th><td>\n<?echo $wss_author?> &lt;<?echo $wss_author_email?>&gt;\n</td></tr>\n<tr><th>\nWSS home page\n</th><td>\n<?echo $wss_url?>\n</td></tr>\n</table><br>\nInformation about this server:<br>\n<table>\n<tr><th>\nSoftware\n</th><td>\n<?echo $SERVER_SOFTWARE?>\n</td></tr>\n<tr><th>\nSignature\n</th><td>\n<?echo $SERVER_SIGNATURE?>\n</td></tr>\n<tr><th>\nProtocol\n</th><td>\n<?echo $SERVER_PROTOCOL?>\n</td></tr>\n<tr><th>\nName\n</th><td>\n<?echo $SERVER_NAME?>\n</td></tr>\n<tr><th>\nAddress\n</th><td>\n<?echo $SERVER_ADDR?>\n</td></tr>\n<tr><th>\nPort\n</th><td>\n<?echo $SERVER_PORT?>\n</td></tr>\n</table><br>\nInformation about this connection:<br>\n<table>\n<tr><th>\nUser agent\n</th><td>\n<?echo $HTTP_USER_AGENT?>\n</td></tr>\n<tr><th>\nUser browser\n</th><td>\n<?echo $browser?>\n</td></tr>\n<tr><th>\nUser operating system\n</th><td>\n<?echo $os?>\n</td></tr>\n<tr><th>\nRequest URI\n</th><td>\n<?echo $REQUEST_URI?>\n</td></tr>\n<tr><th>\nRemote address\n</th><td>\n<?echo $REMOTE_ADDR?>\n</td></tr>\n<tr><th>\nHTTP referer\n</th><td>\n<?echo $HTTP_REFERER?>\n</td></tr>\n</table><br>\nCurrent server time is <?echo strftime(\'%x\')?>, <?echo strftime(\'%X\')?><br><br>\n', '20010508224252', '2', '0');
INSERT INTO article VALUES ( 'Information about <?echo $site_name?>:<br>\nThis site was created by <?echo $site_author?> &lt;<?echo $site_author_email?>&gt;. Name of this site is <?echo $site_name?> and\nit\'s base url is <?echo $site_home?>. Title of this page is <?page_title()?> and it is in category called\n<?category_name()?>. This site was built using <?echo $wss_version?>.', '20010508224252', '3', '0');
INSERT INTO article VALUES ( 'Here will be some short help...', '20010508224252', '4', '0');
INSERT INTO article VALUES ( '<h2>Statistics</h2><h3>Operating systems</h3><?stat_os()?><h3>Browsers</h3><?stat_browser()?>\r\n<h3>Languages</h3>\r\n<?stat_langs(2)?>', '20010508224252', '6', '0');
INSERT INTO article VALUES ( '<h2>Weekly statistics</h2><?stat_weeks()?>', '20010508224252', '7', '0');
INSERT INTO article VALUES ( '<h2>Daily statistics</h2><?stat_days()?>', '20010508224252', '8', '0');
INSERT INTO article VALUES ( '<h2>Hourly statistics</h2><?stat_hours()?>', '20010508224252', '9', '0');
...
INSERT INTO article VALUES ( 'Informace o Web Site System:<br>\r\n<table>\r\n<tr><th>\r\nVerze WSS\r\n</th><td>\r\n<?echo $wss_version?>\r\n</td></tr>\r\n<tr><th>\r\nAutor WSS \r\n</th><td>\r\n<?echo $wss_author?> &lt;<?echo $wss_author_email?>&gt;\r\n</td></tr>\r\n<tr><th>\r\nStránka WSS\r\n</th><td>\r\n<?echo $wss_url?>\r\n</td></tr>\r\n</table><br>\r\nInformace o serveru:<br>\r\n<table>\r\n<tr><th>\r\nSoftware\r\n</th><td>\r\n<?echo $SERVER_SOFTWARE?>\r\n</td></tr>\r\n<tr><th>\r\nSignatura\r\n</th><td>\r\n<?echo $SERVER_SIGNATURE?>\r\n</td></tr>\r\n<tr><th>\r\nProtokol\r\n</th><td>\r\n<?echo $SERVER_PROTOCOL?>\r\n</td></tr>\r\n<tr><th>\r\nNázev\r\n</th><td>\r\n<?echo $SERVER_NAME?>\r\n</td></tr>\r\n<tr><th>\r\nAddresa\r\n</th><td>\r\n<?echo $SERVER_ADDR?>\r\n</td></tr>\r\n<tr><th>\r\nPort\r\n</th><td>\r\n<?echo $SERVER_PORT?>\r\n</td></tr>\r\n</table><br>\r\nInformace o tomto spojení:<br>\r\n<table>\r\n<tr><th>\r\nUser agent\r\n</th><td>\r\n<?echo $HTTP_USER_AGENT?>\r\n</td></tr>\r\n<tr><th>\r\nVás prohlízec\r\n</th><td>\r\n<?echo $browser?>\r\n</td></tr>\r\n<tr><th>\r\nVás operacní systém\r\n</th><td>\r\n<?echo $os?>\r\n</td></tr>\r\n<tr><th>\r\nPozadované URI\r\n</th><td>\r\n<?echo $REQUEST_URI?>\r\n</td></tr>\r\n<tr><th>\r\nVzdálená adresa\r\n</th><td>\r\n<?echo $REMOTE_ADDR?>\r\n</td></tr>\r\n<tr><th>\r\nHTTP referer\r\n</th><td>\r\n<?echo $HTTP_REFERER?>\r\n</td></tr>\r\n</table><br>\r\nCas serveru je <?echo strftime(\'%x\')?>, <?echo strftime(\'%X\')?><br><br>\r\n', '20010605225352', '2', '1');
INSERT INTO article VALUES ( 'Informace o <?echo $site_name?>:<br>\r\nTyto stránky vytvoril <?echo $site_author?> &lt;<?echo $site_author_email?>&gt;. Název tchto stránek je <?echo $site_name?> a\r\njejich hlavní url je <?echo $site_home?>. Název této stránky je <?page_title()?> a je umísten v kategorii nazvané\r\n<?category_name()?>. Tyto stránky byly vytvoreny pomocí  <?echo $wss_version?>.', '20010605225042', '3', '1');
INSERT INTO article VALUES ( 'Zde bude krátká nápoveda', '20010605224827', '4', '1');
INSERT INTO article VALUES ( '<h2>Statistiky</h2>\r\n<h3>Operacní systémy</h3>\r\n<?stat_os()?>\r\n<h3>Prohlízece</h3>\r\n<?stat_browser()?>\r\n<h3>Jazyky</h3>\r\n<?stat_langs(2)?>', '20010605224758', '6', '1');
INSERT INTO article VALUES ( '<h2>Týdení statistiky</h2><?stat_weeks()?>', '20010605225438', '7', '1');
INSERT INTO article VALUES ( '<h2>Denní statistiky</h2><?stat_days()?>', '20010605224700', '8', '1');
INSERT INTO article VALUES ( '<h2>Hodinové statistiky</h2><?stat_hours()?>', '20010605224712', '9', '1');
# --------------------------------------------------------
...
INSERT INTO category VALUES ( '3', '<?echo $site_name?>', '<?echo $site_name?>', '0', 'Some information about <?echo $site_name?>', '3');
...
INSERT INTO page VALUES ( '3', '<?echo $site_name?>', 'article', '', 'Information about <?echo $site_name?>', '<?echo $site_name?>', '37', '0', '3');
...
INSERT INTO page VALUES ( '3', '<?echo $site_name?>', 'article', '', 'Informace o <?echo $site_name?>', '<?echo $site_name?>', '41', '1', '3');
