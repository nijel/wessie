...
if(isset($_SERVER["HTTP_USER_AGENT"])){
    ...
    elseif(
        (ereg('Google|Slurp|LinkAlarm|AltaVista|Lycos|holmes|Ocelli|CloakDetect|YahooSeeker|Ask Jeeves|Nutch|ScoutJet', $_SERVER["HTTP_USER_AGENT"])) ||
    ...
    elseif(eregi('LWP::Simple', $_SERVER["HTTP_USER_AGENT"])) $browser = 'Bot';
