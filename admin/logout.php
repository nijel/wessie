...
header('Location: '.($admin_force_ssl || isset($HTTPS) ? 'https://' : 'http://').$_SERVER['SERVER_NAME'].dirname($_SERVER['SCRIPT_NAME']).(substr(dirname($_SERVER['SCRIPT_NAME']),-5)!='admin'?'admin':'').'/login.php?failure=logout');
